...
from downedit.agents.providers._converter import OpenAIMsgConverter
...
class OpenAI(Provider):
    """
    OpenAI provider for interacting with OpenAI's API.
    ...
    def __init__(
        ...
        """
        self.transformer = OpenAIMsgConverter(chat)
