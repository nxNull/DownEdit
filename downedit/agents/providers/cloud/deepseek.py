...
from downedit.agents.providers._converter import DeepSeekMsgConverter
...
class DeepSeek(Provider):
    """
    DeepSeek provider for interacting with DeepSeek's API.
    ...
    def __init__(
        ...
        """  
        self.transformer = DeepSeekMsgConverter(chat)
    ...
    def chat_completions(self, messages: str, **kwargs):
        """
        Get chat completions from the DeepSeek API.
