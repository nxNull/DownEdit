...
from downedit.agents.providers._converter import XaiMsgConverter
...
class xAI(Provider):
    """
    xAI provider for interacting with xAI's API.
    ...
    def __init__(
        ...
        """
        self.transformer = XaiMsgConverter(chat)
    ...
    def chat_completions(self, messages: str, **kwargs):
        """
        Get chat completions from the xAI API.
